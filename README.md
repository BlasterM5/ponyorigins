...
A test server is now open, if you want to help test the mod. Download [this modpack](https://modrinth.com/mod/pony-origins-test-pack) and connect to the server saved in the list.
