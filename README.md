...
A test server is now open, if you want to help test the mod. Download [this modpack](https://cdn.seaofstreams.com/files/pony-origins-test-pack-1.0.4.mrpack) and connect to the server saved in the list.
